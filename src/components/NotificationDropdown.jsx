        ...
        try {
                    ...
                    if (!targetAnnouncementId && notification.senderId && notification.created_at) {
                        ...
                        try {
                            ...
                            const response = await fetch(
                                `https://tguxydfhxcmqvcrenqbl.supabase.co/rest/v1/notifications_clb?created_by=eq.${notification.senderId}&created_at=gte.${timeWindowStart}&created_at=lte.${timeWindowEnd}&select=id,created_at&order=created_at.desc&limit=5`,
                                {
                                    headers: {
            ...
            if (!postId && commentId) {
                ...
                if (commentId) {
                    ...
                    fetch(
                        `https://tguxydfhxcmqvcrenqbl.supabase.co/rest/v1/comments?id=eq.${commentId}&select=postId`,
                        {
                            headers: {
                                'apikey': 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im9xdGxha2R2bG1rYWFseW1ncndkIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NDg4MzA3MTYsImV4cCI6MjA2NDQwNjcxNn0.FeGpQzJon_remo0_-nQ3e4caiWjw5un9p7rK3EcJfjY',
                                'Authorization': 'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im9xdGxha2R2bG1rYWFseW1ncndkIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NDg4MzA3MTYsImV4cCI6MjA2NDQwNjcxNn0.FeGpQzJon_remo0_-nQ3e4caiWjw5un9p7rK3EcJfjY'
                    ...
                    if ((isComment || isLike) && notification.senderId && notification.receiverId) {
                        ...
                        if (isComment) {
                            ...
                            fetch(
                                `https://tguxydfhxcmqvcrenqbl.supabase.co/rest/v1/posts?userId=eq.${notification.receiverId}&select=id`,
                                {
                                    headers: {
                                        'apikey': 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im9xdGxha2R2bG1rYWFseW1ncndkIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NDg4MzA3MTYsImV4cCI6MjA2NDQwNjcxNn0.FeGpQzJon_remo0_-nQ3e4caiWjw5un9p7rK3EcJfjY',
                                        'Authorization': 'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im9xdGxha2R2bG1rYWFseW1ncndkIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NDg4MzA3MTYsImV4cCI6MjA2NDQwNjcxNn0.FeGpQzJon_remo0_-nQ3e4caiWjw5un9p7rK3EcJfjY'
                            ...
                            .then(posts => {
                                ...
                                return fetch(
                                    `https://tguxydfhxcmqvcrenqbl.supabase.co/rest/v1/comments?userId=eq.${notification.senderId}&postId=in.(${postIds})&created_at=gte.${timeWindowStart}&created_at=lte.${timeWindowEnd}&order=created_at.desc&limit=20&select=id,postId,created_at`,
                                    {
                                        headers: {
                                            'apikey': 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im9xdGxha2R2bG1rYWFseW1ncndkIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NDg4MzA3MTYsImV4cCI6MjA2NDQwNjcxNn0.FeGpQzJon_remo0_-nQ3e4caiWjw5un9p7rK3EcJfjY',
                                            'Authorization': 'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im9xdGxha2R2bG1rYWFseW1ncndkIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NDg4MzA3MTYsImV4cCI6MjA2NDQwNjcxNn0.FeGpQzJon_remo0_-nQ3e4caiWjw5un9p7rK3EcJfjY'
                            ...
                            .then(posts => {
                                ...
                                return fetch(
                                    `https://tguxydfhxcmqvcrenqbl.supabase.co/rest/v1/postLikes?userId=eq.${notification.senderId}&postId=in.(${postIds})&created_at=gte.${timeWindowStart}&created_at=lte.${timeWindowEnd}&order=created_at.desc&limit=20&select=postId,created_at`,
                                    {
                                        headers: {
                                            'apikey': 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im9xdGxha2R2bG1rYWFseW1ncndkIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NDg4MzA3MTYsImV4cCI6MjA2NDQwNjcxNn0.FeGpQzJon_remo0_-nQ3e4caiWjw5un9p7rK3EcJfjY',
                                            'Authorization': 'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im9xdGxha2R2bG1rYWFseW1ncndkIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NDg4MzA3MTYsImV4cCI6MjA2NDQwNjcxNn0.FeGpQzJon_remo0_-nQ3e4caiWjw5un9p7rK3EcJfjY'
