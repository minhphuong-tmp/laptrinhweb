...
const Activities = () => {
                        ...
                        if (current.getDay() === targetDay) {
                            ...
                            if (periods.length > 0) {
                                ...
                                events.push({
                                    ...
                                    description: `Mã: ${course.course_code} - Lớp: ${course.stt || ''}\nTiết: ${startPeriod}-${endPeriod} (${sched.type || ''})\nGV: ${course.lecturer || ''}`,
    ...
    useEffect(() => {
        const storedLogin = localStorage.getItem('qldt_sched_login');
        if (storedLogin) {
            ...
            if (parsed.scheduleData) {
                ...
                setActivities(prev => {
                    // Filter out old qldt events to avoid duplication if strict mode runs twice
