...
export const AuthProvider = ({ children }) => {
    ...
    const signIn = async (email, password) => {
        ...
        try {
            ...
            const signInResponse = await fetch('https://tguxydfhxcmqvcrenqbl.supabase.co/auth/v1/token?grant_type=password', {
                method: 'POST',
                headers: {
                    'apikey': apiKey,
            ...
            localStorage.setItem('sb-tguxydfhxcmqvcrenqbl-auth-token', JSON.stringify(authData));
